...
import { IconCircleCheck, IconReportMedical } from '@tabler/icons-react';
import { useEffect, useState } from 'react';
import { useParams } from 'react-router-dom';

export function QuestionnairePathReport({imagingstudyId}): JSX.Element {
  // const { id } = useParams();
  ...
  return (
    <Document>
      ...
      <QuestionnaireForm submitButtonText={'Save'} questionnaire={questionnaire} onSubmit={!submitted ? handleSubmit : console.log} />
