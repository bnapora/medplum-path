...
import { CasePath } from './pages/health-record/CasePath';
import { CasesPath } from './pages/health-record/CasesPath';
import { Vitals } from './pages/health-record/Vitals';
import { HomePage } from './pages/HomePage';
import { Messages } from './pages/MessagesPage';
import { ObservationPage } from './pages/ObservationPage';
import { SignOutPage } from './pages/SignOutPage';
import { ResourcePage } from  './pages/health-record/ResourcePage';
  ...
  return (
    <Routes>
      ...
      <Route path="health-record/*" element={<HealthRecord />}>
        <Route index element={<Navigate replace to="/health-record/cases-path" />} />
        ...
        <Route path="cases-path" element={<CasesPath />} />
        <Route path="case-path/:imagingstudyId" element={<CasePath />} />
